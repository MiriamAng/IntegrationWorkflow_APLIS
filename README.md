...
4. customize the the script src/server_client_system.py path to 
5. run the script under src/server_client_system.py
```bash
python src/server_client_system.py
```
4. listen for incoming OUL^O33 HL7 messages 
